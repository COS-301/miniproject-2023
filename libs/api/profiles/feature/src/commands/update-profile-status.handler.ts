...
import { IUpdateProfileStatusResponse, UpdateProfileStatusCommand } from '@mp/api/profiles/util';
import { CommandHandler, EventPublisher, ICommandHandler } from '@nestjs/cqrs';
import { Profile } from '../models';

@CommandHandler(UpdateProfileStatusCommand)
export class UpdateProfileStatusHandler implements ICommandHandler<UpdateProfileStatusCommand> {
